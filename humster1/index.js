...
function win() {
  ...
  image.animate([{ opacity: 1 }, { top: 0, opacity: 1 }], {
    duration: 30000,
    fill: "forwards",
  });

  new Audio("./sanya2024.mp3").play();
...
function render() {
  ...
  // шкала заполнения
  progressBar.style.background = `linear-gradient(to left, transparent ${((FINAL_SCORE - score) / FINAL_SCORE) * 100}%, #cebc81 ${
